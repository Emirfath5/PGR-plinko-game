...
const erc20ABI = [...];
const erc20Address = '0x1234567890123456789012345678901234567890'; // Replace with your ERC-20 contract address
  ...
  async function handleRedeemGift() {
    try {
      ...
      if (userTokenBalance >= redemptionAmount) {
        ...
        await erc20Contract.methods.transfer(YOUR_REDEMPTION_ADDRESS, redemptionAmount).send({
          from: userAddress,
        });
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 text-text">
      ...
      <span className="text-center text-lg font-bold">
        ...
        <br /> each time your balance is below{'10 '}
