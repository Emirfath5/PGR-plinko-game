...
export function ScoreBoardPage() {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4" style={{ background: 'url("grim-reaper-background.jpg")', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
